  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-[var(--radius-DEFAULT)] border border-[var(--cmd-border)]",
        "bg-[var(--cmd-bg)] shadow-[var(--shadow-lg)]",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-xs font-medium text-[var(--text-tertiary)] uppercase tracking-wide",
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-[var(--radius-sm)] py-1.5 pl-8 pr-2 text-sm text-[var(--text-primary)]",
      "outline-none transition-colors duration-[var(--duration-micro)]",
      "focus:bg-[var(--cmd-item-hover)]",
